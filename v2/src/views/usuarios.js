export function renderUsuariosPage() {
  return `
    ...
    <div class="card mt-4">
      <h2 class="mb-3 text-sm font-semibold text-slate-300">Unidades</h2>
      ...
      <table class="mt-4 w-full text-left text-sm">
        <thead class="text-slate-400"><tr><th class="pb-2">Nome</th><th class="pb-2">UF</th><th class="pb-2">Matriz</th><th class="pb-2 text-right">Acoes</th></tr></thead>
        <tbody id="tabela-unidades"></tbody>
      </table>
    </div>

    <div class="card mt-4">
      <h2 class="mb-3 text-sm font-semibold text-slate-300">Tipos de CT-e</h2>
