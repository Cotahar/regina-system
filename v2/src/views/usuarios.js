export function renderUsuariosPage() {
  return `
    ...
    <div class="card mt-4">
      <h2 class="mb-3 text-sm font-semibold text-slate-300">Cadastrar / editar usuario</h2>
      ...
      <table class="mt-4 w-full text-left text-sm">
        <thead class="text-slate-400"><tr><th class="pb-2">Usuario</th><th class="pb-2">Permissao</th><th class="pb-2 text-right">Acoes</th></tr></thead>
        <tbody id="tabela-usuarios"></tbody>
      </table>
    </div>

    <div class="card mt-4">
      <h2 class="mb-3 text-sm font-semibold text-slate-300">🏢 Configuracao de Unidades e Regras de Origem</h2>
      <p class="mb-3 text-xs text-slate-400">A unidade Matriz e o padrao. Quando o remetente for de uma UF sem unidade cadastrada, o sistema usa a Matriz com o "Tipo CT-e (outra UF)" configurado abaixo.</p>
      ...
      <table class="mt-4 w-full text-left text-sm">
        <thead class="text-slate-400"><tr><th class="pb-2">Nome</th><th class="pb-2">UF</th><th class="pb-2">Matriz</th><th class="pb-2">Tipo CT-e outra UF</th><th class="pb-2 text-right">Acoes</th></tr></thead>
        <tbody id="tabela-unidades"></tbody>
      </table>
    </div>

    <div class="card mt-4">
      <h2 class="mb-3 text-sm font-semibold text-slate-300">🚛 Tipos de CT-e / Documentos</h2>
