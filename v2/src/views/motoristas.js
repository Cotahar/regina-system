export function renderMotoristasPage() {
  return `
    ...
    <div class="card mt-4">
      <h2 class="mb-3 text-sm font-semibold text-slate-700">Importar planilha (CSV: codigo, nome)</h2>
      ...
      <details class="mt-3">
        <summary class="cursor-pointer text-xs text-slate-600">ou colar linhas copiadas do Excel (codigo [tab] nome)</summary>
    ...
    <div id="modal-motorista" class="fixed inset-0 z-20 hidden items-center justify-center bg-slate-900/50">
      <form id="form-motorista" class="card w-full max-w-md">
        ...
        <div class="mb-3">
          <label class="mb-1 block text-xs text-slate-600">Codigo</label>
