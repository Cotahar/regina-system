export function renderVeiculosPage() {
  return `
    ...
    <div class="card mt-4">
      <h2 class="mb-3 text-sm font-semibold text-slate-700">Importar planilha (CSV: placa)</h2>
      ...
      <details class="mt-3">
        <summary class="cursor-pointer text-xs text-slate-600">ou colar linhas copiadas do Excel (placa)</summary>
    ...
    <div id="modal-veiculo" class="fixed inset-0 z-20 hidden items-center justify-center bg-slate-900/50">
      <form id="form-veiculo" class="card w-full max-w-md">
        ...
        <div class="mb-4">
          <label class="mb-1 block text-xs text-slate-600">Placa</label>
