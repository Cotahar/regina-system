export function renderVeiculosPage() {
  return `
    ...
    <div class="card mt-4">
      <h2 class="mb-3 text-sm font-semibold text-slate-300">Importar planilha (CSV ou Excel: placa)</h2>
      ...
      <div class="overflow-x-auto">
        <table class="w-full text-left text-sm">
          <thead class="text-slate-400">
            <tr><th class="pb-2">Placa</th><th class="pb-2">Frota</th><th class="pb-2 text-right">Acoes</th></tr>
          </thead>
