"""V2 - Adicionando motoristas, veiculos e remetentes

Revision ID: f194e970e7ab
Revises: 
Create Date: 2025-11-03 15:04:07.854991
...
def upgrade():
    ...
    sa.Column('is_remetente', sa.Boolean(), nullable=False),
